...
- **[MarkScan](https://www.pref.kanagawa.jp/docs/t4e/cnt/f100212/)** （神奈川県教育委員会） — マークシート処理ソフト。教員として実際に使用し、操作フローを参考にしました。
- **[Mark2](https://github.com/Mark2OSS/Mark2)** （慶應義塾大学 SFC 研究所） — マークシートの座標系と OMR ロジックの技術基盤として利用しています。
