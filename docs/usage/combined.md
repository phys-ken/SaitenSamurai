...
マーク＋記述モードでは、マーク採点と同じ 3 つのファイルを用意します。

| ファイル | 説明 |
|---|---|
| **Mark2 座標ファイル** | Mark2 で作成した座標 Excel |
| **正答ファイル** | マーク問題の正答を記入した Excel |
...
統合セットアップ画面で、記述式の問題領域をマウスで指定します。

![統合セットアップ](../images/19_integrated_descriptive_setup.png){ .screenshot }
<span class="caption">記述式の領域設定（統合セットアップ画面）</span>
...
| 出力先 | 内容 |
|---|---|
| `01_Results/` | 生徒別成績サマリー Excel（マーク＋記述の合計） |
